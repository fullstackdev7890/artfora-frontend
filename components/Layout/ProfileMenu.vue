<template>
  <div class="profile-menu" ref="profileRef">
    <div class="icon-button" @click="menuDropdownRef.toggleCollapsing">
      <img src="~/assets/images/logo.jpg" alt="user_avatar">
    </div>
    <ui-kit-dropdown title="Menu" ref="menuDropdownRef" :inside-area="profileRef">

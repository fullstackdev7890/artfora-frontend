  ...
  <div class="profile-menu">
    ...
    <ui-kit-dropdown title="Menu" ref="menuDropdownRef">
      <div v-if="isAuthorized" class="ui-kit-dropdown-content-item">
        <span @click="openSetUpAccountModal" class="ui-kit-dropdown-content-item-btn"
          >My Settings</span
        >
      </div>
      ...
      <div v-if="!isAuthorized" class="ui-kit-dropdown-content-item">
        <span @click="openLogInModal" class="ui-kit-dropdown-content-item-btn"
          >Log in/Sign up</span
        >
      </div>

      <div class="ui-kit-dropdown-content-item">
        <span @click="openSettingsGallery" class="ui-kit-dropdown-content-item-btn"
          >Gallery settings</span
        >
      </div>
      <div class="ui-kit-dropdown-content-item">
        <span @click="openAboutArtforaModal" class="ui-kit-dropdown-content-item-btn"
          >About ARTfora</span
        >
      </div>
      <div class="ui-kit-dropdown-content-item">
      ...
      <div class="ui-kit-dropdown-content-item">
        <span @click="openContactUsModal" class="ui-kit-dropdown-content-item-btn"
          >Contact us</span
        >
      </div>
...
const emit = defineEmits([
  ...
  "openSignUpModal",
  "openContactUsModal",
  "openGallerySettingsModal",
  "openFaqModal",
  "openStartSellingModal",
  "openSetUpAccountModal",
  "openAboutArtforaModal",
]);
